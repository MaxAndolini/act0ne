            ...
            return Container(
              ...
              Column(
                  ...
                  children: [
                    Row(children: [
                      //First Item
                      _listItem(context, document['toy_item1'],
                          document['price1'], document['photo1']),

                      //Second Item
                      _listItem(context, document['toy_item2'],
                          document['price2'], document['photo2']),

                      //Third Item
                      _listItem(context, document['toy_item3'],
                          document['price3'], document['photo3'])
                    ]),
                    Row(children: [
                      //Fourth Item
                      _listItem(context, document['toy_item4'],
                          document['price4'], document['photo4']),

                      //Fifth Item
                      _listItem(context, document['toy_item5'],
                          document['price5'], document['photo5']),

                      //Sixth Item
                      _listItem(context, document['toy_item6'],
                          document['price6'], document['photo6'])
                    ]),
                    Row(children: [
                      //Seventh Item
                      _listItem(context, document['toy_item7'],
